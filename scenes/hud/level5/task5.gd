...
func show_task():
	...
	if num_num == 1:
		$Label2.text = Tasks.task2_3_lvl5
	if num_num == 2:
		$Label2.text = Tasks.task2_1_lvl5
	if num_num == 3:
		$Label2.text = Tasks.task2_2_lvl5
...
func show_task2():
	...
	$Label.text = "Чтобы пройти дальше ответьте на вопрос"
	if num_num == 1:
		$Label2.text = Tasks.task1_3_lvl5
	if num_num == 2:
		$Label2.text = Tasks.task1_1_lvl5
	if num_num == 3:
		$Label2.text = Tasks.task1_2_lvl5
